...
static void testTrainWindowCycleActivePanel()
{
  TestScope _t("testTrainWindowCycleActivePanel");
...
static void testTrainWindowScrollActivePanel()
{
  TestScope _t("testTrainWindowScrollActivePanel");
...
static void testTrainWindowScrollRouting()
{
  TestScope _t("testTrainWindowScrollRouting");
...
static void testTrainWindowHandleEvent()
{
  TestScope _t("testTrainWindowHandleEvent");
...
static void testTableUtf8RightBorder()
{
  TestScope _t("testTableUtf8RightBorder");
  ...
  for (int i = 0; i < static_cast<int>(lines.size()); i++) {
    ...
    if (isSeparator) {
      ...
      CHECK(!lines[i].empty() && lines[i].back() == '+', "Separator line " + std::to_string(i) + " must end with '+'");
    } else {
  ...
  CHECK(static_cast<int>(newTruncated.size()) == utf8Bytes, "NEW truncation must include all bytes (nothing cut off)");
}

//===================================================================================================================//

static void testPredictWindowDefaultActivePanel()
{
  TestScope _t("testPredictWindowDefaultActivePanel");
...
static void testPredictWindowTabCyclesPanels()
{
  TestScope _t("testPredictWindowTabCyclesPanels");
...
static void testPredictWindowScrollRouting()
{
  TestScope _t("testPredictWindowScrollRouting");
  ...
  CHECK(pw.getModelInfoPanel()->scrollState().offset == 2, "Scroll offset should increase to 2 after second KEY_DOWN");
...
static void testPredictWindowHandleEvent()
{
  TestScope _t("testPredictWindowHandleEvent");
...
static void testPredictWindowDismissOnQ()
{
  TestScope _t("testPredictWindowDismissOnQ");
...
static void testPredictWindowResultsTable()
{
  TestScope _t("testPredictWindowResultsTable");
...
static void testPredictWindowChildCount()
{
  TestScope _t("testPredictWindowChildCount");
...
void runTerminalUITests()
{
  ...
  testPredictWindowTabCyclesPanels();
  testPredictWindowScrollRouting();
  testPredictWindowHandleEvent();
