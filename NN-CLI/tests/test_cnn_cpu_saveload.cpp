...
{
  TestScope _t("testCNNSaveLoadPredictConsistency");
  ...
  QString outDir = tempDir() + "/cnn_slpc_out";
  ...
  QString predictOut1 = tempDir() + "/cnn_slpc_predict1_out";
  ...
  QString predictOut2 = tempDir() + "/cnn_slpc_predict2_out";
