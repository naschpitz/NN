...
namespace NN_CLI
{
  ...
  TerminalUI_ResultsWindow::TerminalUI_ResultsWindow(const std::string& title, int titleColor,
                                                     const std::vector<TerminalUI_Table::Column>& defaultResultColumns,
                                                     std::vector<int> resultColumnWidthHints)
    : resultColumnWidthHints(std::move(resultColumnWidthHints))
  {
    ...
    //-- panel: the loading bar on top, the main bar below.                --//
    ...
    //-- Configure the results table with the subclass-provided columns --//

    if (!defaultResultColumns.empty())
      this->resultsTable.setColumns(defaultResultColumns);

    this->setShortcutBar(
      "Tab: panels \xe2\x86\x91\xe2\x86\x93: scroll PgUp/PgDn: page Home/End: top/bottom q/ESC: quit");
    this->setTitleBar(title, titleColor);
  }

  //===================================================================================================================//

  TerminalUI_ResultsWindow::~TerminalUI_ResultsWindow() {}

  //===================================================================================================================//
  //-- Layout --//
  //===================================================================================================================//

  void TerminalUI_ResultsWindow::layoutChildren()
  {
    int W = this->width;
  ...
  void TerminalUI_ResultsWindow::updateProgress(const std::string& label, float fraction)
  {
  ...
  void TerminalUI_ResultsWindow::updateProgress(const std::string& label, const std::vector<float>& fractions)
  {
    if (this->progressBarPtr)
  ...
  void TerminalUI_ResultsWindow::updateProgressSubLine(const std::string& line)
  {
    if (this->progressBarPtr)
  ...
  void TerminalUI_ResultsWindow::clearProgressSubLine()
  {
    if (this->progressBarPtr)
  ...
  void TerminalUI_ResultsWindow::setLoadingProgress(const std::string& label, float fraction)
  {
  ...
  void TerminalUI_ResultsWindow::clearLoadingProgress()
  {
    if (this->loadingBarPtr)
  ...
  void TerminalUI_ResultsWindow::setModelInfoRows(const std::vector<SummaryRow>& rows)
  {
  ...
  void TerminalUI_ResultsWindow::refreshModelInfoContent()
  {
  ...
  void TerminalUI_ResultsWindow::setTimingLines(const std::vector<std::string>& lines)
  {
  ...
  void TerminalUI_ResultsWindow::refreshTimingContent()
  {
  ...
  void TerminalUI_ResultsWindow::setEpochHistoryLines(const std::vector<std::string>& lines)
  {
  ...
  void TerminalUI_ResultsWindow::refreshEpochHistoryContent()
  {
  ...
  void TerminalUI_ResultsWindow::setResultsColumns(const std::vector<std::string>& columns)
  {
    if (columns.size() >= 1) {
      ...
      for (ulong i = 0; i < columns.size(); i++) {
        int widthHint = (i < this->resultColumnWidthHints.size()) ? this->resultColumnWidthHints[i] : 10;
  ...
  void TerminalUI_ResultsWindow::addResultRow(const std::vector<std::string>& row)
  {
  ...
  void TerminalUI_ResultsWindow::addResultRows(const std::vector<std::vector<std::string>>& rows)
  {
  ...
  void TerminalUI_ResultsWindow::clearResultRows()
  {
  ...
  void TerminalUI_ResultsWindow::refreshResultsContent()
  {
  ...
  void TerminalUI_ResultsWindow::setActivePanel(int panelIndex)
  {
  ...
  int TerminalUI_ResultsWindow::getActivePanel() const
  {
  ...
  TerminalUI_Panel* TerminalUI_ResultsWindow::getProgressPanel() const
  {
  ...
  TerminalUI_Panel* TerminalUI_ResultsWindow::getModelInfoPanel() const
  {
  ...
  TerminalUI_Panel* TerminalUI_ResultsWindow::getTimingPanel() const
  {
  ...
  TerminalUI_Panel* TerminalUI_ResultsWindow::getEpochHistoryPanel() const
  {
  ...
  TerminalUI_Panel* TerminalUI_ResultsWindow::getResultsPanel() const
  {
  ...
  void TerminalUI_ResultsWindow::waitForDismiss()
  {
  ...
  void TerminalUI_ResultsWindow::preRender()
  {
  ...
  bool TerminalUI_ResultsWindow::cycleActivePanel(int ch)
  {
    if (ch != '\t')
      return false;
  ...
  bool TerminalUI_ResultsWindow::scrollActivePanel(int ch)
  {
  ...
  bool TerminalUI_ResultsWindow::handleEvent(int ch)
  {
  ...
  void TerminalUI_ResultsWindow::syncProgressBarLayout()
  {
    if (!this->loadingBarPtr || !this->progressBarPtr)
      return;
  ...
  void TerminalUI_ResultsWindow::updatePanelColors()
  {
