#include "NN-CLI_LoadingBarController.hpp"
...
namespace NN_CLI
{
  ...
  void LoadingBarController::attach(std::shared_ptr<TerminalUI> tui, std::function<void()> onResize)
  {
  ...
  void LoadingBarController::resolveBarGpus(bool deviceIsGpu, int numGpusConfig)
  {
    this->barGpus = 1;
  ...
  std::function<void(ulong, ulong, ulong, ulong, SampleLoadType)> LoadingBarController::loadingCallback()
  {
  ...
  void LoadingBarController::initTracker(ulong progressReports, ulong windowSize, int barWidth)
  {
  ...
  void LoadingBarController::updateProgress(const ProgressInfo& progress)
  {
  ...
  void LoadingBarController::renderBar()
  {
