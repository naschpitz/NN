#ifndef NN_CLI_LOADINGBARCONTROLLER_HPP
#define NN_CLI_LOADINGBARCONTROLLER_HPP
...
namespace NN_CLI
{
  ...
  //
  // Extracted from the former TrainingController during the MVC refactor so that the
  // loading-bar / progress-tracking concerns remain available to Runner while the
  // TrainingController name is repurposed for the new MVC observer class.
...
#endif // NN_CLI_LOADINGBARCONTROLLER_HPP
