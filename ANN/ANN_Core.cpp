...
{
  // Wrap an in-memory Inputs<T> as a one-shot InputProvider and delegate to
  // the streaming overload. The provider returns slices of the original
  // vector; the per-input float buffers are reference-copied (cheap).
