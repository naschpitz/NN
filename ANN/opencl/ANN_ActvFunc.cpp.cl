...
void actvFunc_softmax(global TYPE* zs, global TYPE* actvs, ulong numNeurons, ulong actvOffset)
{
...
void actvFunc_calculate(global TYPE* zs, global TYPE* actvs, ulong numNeurons, ActvFuncType type, ulong actvOffset)
{
...
TYPE actvFunc_derivative(global TYPE* actvs, global TYPE* zs, global TYPE* dCost_dActvs, ulong j, ulong numNeurons,
                         ActvFuncType type, ulong actvOffset)
{
  TYPE z = zs[actvOffset + j];
